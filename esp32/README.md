...
Shared core: `PccsEspFirmware.h` (copied into each sketch folder).
...
- Water sender on ESP32-1 GPIO 1: empty ~240 Ω, full ~33 Ω (`config/pccs.conf` `[sensors]`)
