/**
 * PCCS5 Climate tile — outside/fridge temps, 24h scrolling forecast, hints.
 */
(function () {
    'use strict';
    ...
    const home = window.pccs5Location;
    ...
    window.climateTile = window.PCCS5.climate;
    window.temperatureTile = window.PCCS5.climate;
    window.weatherTile = window.PCCS5.climate;
})();