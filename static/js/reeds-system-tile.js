/**
 * PCCS5 Reed switches tile — live hardware + diag force controls.
 */
(function () {
    'use strict';
    ...
    function applyForceResult(data) {
        ...
        window.PCCS5.lightingHome?.onStateUpdate?.(data.state);
    }
    ...
    function emitForceReed(name, closed) {
        ...
        fetch('/api/reeds/force', {
            ...
            .catch((err) => console.warn('[PCCS5] force_reed HTTP failed', err));
    }
    ...
    async function loadReeds() {
        ...
        try {
            ...
            console.warn('[PCCS5] Failed to load reeds', err);
        }
    }
    ...
    window.reedsSystemTile = window.PCCS5.reedsSystem;
})();