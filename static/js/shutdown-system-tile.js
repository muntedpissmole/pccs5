/**
 * PCCS5 Shutdown tile — power off the host Pi and configured touchscreens.
 */
(function () {
    'use strict';
    ...
    async function loadTargets() {
        ...
        try {
            ...
            console.warn('[PCCS5] shutdown tile load failed', err);
        }
    ...
    async function shutdownAll() {
        ...
        try {
            ...
            console.warn('[PCCS5] shutdown request failed', err);
