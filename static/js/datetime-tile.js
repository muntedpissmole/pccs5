/**
 * PCCS5 Date & Time tile — clock, sunrise/sunset, sun/moon bezier arc.
 */
(function () {
    'use strict';
    ...
    // pccs5Location is always an object (even with null coords before GPS).
    // Treat missing/null lat/lng as "use timezone fallback", not 0,0 (null island).
    const defaults = resolveCoords(window.pccs5Location);
    ...
    window.PCCS5.datetime = { updatePhaseTimes };
