/**
 * PCCS5 home location — suburb, coordinates, satellites (Adafruit Ultimate GPS).
 */
(function () {
    'use strict';
    ...
    window.PCCS5.location = { update, onGpsUpdate, refresh: fetchGps };

    window.locationTile = window.PCCS5.location;
})();