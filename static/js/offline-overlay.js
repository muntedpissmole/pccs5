/**
 * PCCS5 offline overlay — shown when Socket.IO disconnects or is unavailable.
 */
(function () {
    'use strict';
    ...
    function initNoSocketClient() {
        ...
        console.warn('[PCCS5] Socket.IO unavailable — showing offline overlay');
        show();
    }

    window.PCCS5 = window.PCCS5 || {};
    window.PCCS5.offline = { show, hide, register, initNoSocketClient };
